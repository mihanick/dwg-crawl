...
namespace DwgDump
{
	public class Prediction
	{
		...
		/// <returns></returns>
		static private (Bitmap, BoundBlock) CreatePreview(List<McObjectId> formatEntIds, int imageSize = 512)
		{
			var bbOx = new BoundBlock();
			foreach (var entId in formatEntIds)
			{
			...
			Metafile mf = McNativeGate.CreateEmf(formatEntIds, p);
		...
		public static void Predict()
		{
			...
			// write image
			(var image, var bound) = CreatePreview(currentSelection);
